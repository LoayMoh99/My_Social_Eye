...
def VideoCam():
    ...
    while True:
        ...
        #TODO Put the code you want to run here for camera testing code in the app 
        ...
        if keyboard.is_pressed('s'):
            ...
            #TODO End the fcamera testing code
            break
...
#### buliding the frame 
frameMain =LabelFrame(root, text="Welcoming Frame", padx=50, pady=50,bg="white")
...
root.bind("<x>",activateMeetingAnalytics)  # to go to  activate the meeting analytics 
